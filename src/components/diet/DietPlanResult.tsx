...
import { CalendarRange, Utensils, Salad } from 'lucide-react';
...
const DietPlanResult: React.FC<DietPlanResultProps> = ({ plan }) => {
  return (
      ...
      <div className="space-y-6">
        <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-100 dark:border-green-800/30">
          ...
          <div className="space-y-2">
            ...
            <p className="text-green-700 dark:text-green-300 text-sm">
              <span className="font-medium">Daily Caloric Intake:</span> {plan.dailyCalories} calories
            </p>
            <p className="text-green-700 dark:text-green-300 text-sm">
